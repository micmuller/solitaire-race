...
export const WEB_PIXI_CLIENT_VERSION = '0.3.2';
...
let mode = 'split', baseUrl = storageGet(STORAGE.server) || window.location.origin, client = null, lobbyPlayer = null, activeGame = null, activeKind = 'human', selection = null, audioContext = null, celebrated = null, gameOverQueued = null, gameOverTimer = null, refreshedFinishedProfile = null;
const debugLines=[];
...
$('#menu-mode').onchange=()=>setMode($('#menu-mode').value); $('#bot-mode').onchange=()=>setMode($('#bot-mode').value); $('#menu-host-bot').onclick=()=>hostBot(false,$('#bot-speed').value,$('#bot-mode').value); $('#menu-bot-versus').onclick=()=>hostBot(true,$('#bot-speed').value,$('#bot-mode').value); $('#menu-connect-match').onclick=()=>connect($('#menu-match-id').value.trim(),$('#menu-role').value).catch(e=>showToast(e.message,'error'));
