# Solitaire HighNoon icon candidates
...
The installable PWA derivatives live under `public/icons/`. They are generated
from candidate A at 192 × 192, 512 × 512, maskable 512 × 512 and Apple touch
icon 180 × 180 sizes. The maskable derivative keeps the emblem inside the safe
area with a dark-brown background.
